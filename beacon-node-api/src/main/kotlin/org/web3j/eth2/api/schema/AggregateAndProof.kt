...
/**
 * The [AggregateAndProof](https://github.com/ethereum/eth2.0-specs/blob/v0.12.2/specs/phase0/validator.md#signedaggregateandproof)
 * object from the Eth2.0 spec.
 */
data class AggregateAndProof(
    @JsonProperty("aggregator_index")
    val aggregatorIndex: ValidatorIndex,
