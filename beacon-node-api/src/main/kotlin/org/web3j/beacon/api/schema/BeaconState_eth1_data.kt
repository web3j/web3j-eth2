...
/**
 * The [`Eth1Data`](https://github.com/ethereum/eth2.0-specs/blob/v0.12.2/specs/phase0/beacon-chain.md#eth1data) object from the Eth2.0 spec.
 * @param depositRoot
 * @param depositCount
 * @param blockHash
 */
data class BeaconStateEth1Data(
